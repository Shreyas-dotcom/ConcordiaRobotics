...
//Intake 
pros::MotorGroup intake({17, 18}, pros::MotorGearset::green);

//Lady Brown
pros::MotorGroup ladybrown({ 19, 20 }, pros::MotorGearset::green);

//Piston
pros::adi::Pneumatics clamp('G', false);
pros::adi::Pneumatics tipper('H', false);
